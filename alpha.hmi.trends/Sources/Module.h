...
////////////////////////////////////////////////////////////////////////////////
class TrendsModuleClassFactory : public Alpha::Binbo::i_class_factory
{
public:

	TrendsModuleClassFactory();
	virtual ~TrendsModuleClassFactory();
...
}; // class TrendsModuleClassFactory


////////////////////////////////////////////////////////////////////////////////
///	@short
///		Модуль компонента Тренды.
////////////////////////////////////////////////////////////////////////////////
class TrendsModule : public Alpha::Om::IUnitModule
{
public:

	TrendsModule();
	virtual ~TrendsModule();
